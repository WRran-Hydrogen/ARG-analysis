...
<p style="background: #fffced; box-sizing: border-box; padding: 10px 20px; font-style: italic;">**Update June 2023:** This notebook has been deprecated and is no longer maintained; please see the newer [Sankey diagram example](/@d3/sankey/2?intent=fork).</p>
...
FileAttachment("Habitat_refined.csv").csv({typed: true})
)}
...
function SankeyChart({
  ...
  colors = d3.schemePastel1, // array of colors
...
require.alias({"d3-ay": d3, "d3-shape": d3, "d3-sankey": "d3-sankey@0.12.3/dist/d3-sankey.min.js"})("d3-sankey")
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["Habitat_refined.csv", {url: new URL("./files/e9558fb2c2156d8081ff349392feb18a44c6860bcbcb3ef28ec4d7c8f06978f0435046c93008fa404a7436f0559eabcc462fd152376769ae16262769233ee416.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
